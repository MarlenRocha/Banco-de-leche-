...
class EspecialidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidad" do
    assert_difference('Especialidad.count') do
      post especialidades_url, params: { especialidad: { agrupacion: @especialidad.agrupacion, anio: @especialidad.anio, descripcion: @especialidad.descripcion, lugar: @especialidad.lugar, nombre: @especialidad.nombre, orientacion: @especialidad.orientacion } }
    end
  ...
  test "should update especialidad" do
    patch especialidad_url(@especialidad), params: { especialidad: { agrupacion: @especialidad.agrupacion, anio: @especialidad.anio, descripcion: @especialidad.descripcion, lugar: @especialidad.lugar, nombre: @especialidad.nombre, orientacion: @especialidad.orientacion } }
